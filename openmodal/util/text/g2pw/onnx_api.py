...
from ..languages.zh_normalization.char_convert import tranditional_to_simplified
...
class G2PWOnnxConverter:
    def __init__(self,
        ...
        try:
            self.session_g2pW = onnxruntime.InferenceSession(os.path.join(uncompress_path, 'g2pW.onnx'),
