...
class TTSFlow(BaseFlow):
    def __init__(self, tts_model: BaseModel, speaker: any, output_dir: Union[str], output_format='wav', *args,
                 **kwargs):
        """
    ...
    def forward(self, input: str, output_filename: Optional[str] = None, speed=1.0) -> any:
        ...
        if output_filename is not None:
            output_path = os.path.join(self.output_dir, f"{output_filename}.{self.output_format}")
